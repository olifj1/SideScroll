...
Eight new processed woodland tree PNGs are packed into the dedicated 2048×2048 `sidescroll-tree-atlas.png`. The atlas keeps the same GPU footprint while exposing the full eight-tree family in procedural scenery and the editor.
